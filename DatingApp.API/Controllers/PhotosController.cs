    ...
    public class PhotosController : ControllerBase
    {
        ...
        IMapper mapper)
        {
            ...
            Account acc = new Account(
                "dx7lsrwry", "638244244133898", "nkOdOO34Lziyiq6nxAll6jfqAvM"
            );
        ...
        private bool checkId(int userId)
        {
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            var curretnMainPhoto = await _repo.GetMainPhotoForUser(userId);

            curretnMainPhoto.IsMain = false;
